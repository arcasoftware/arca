...
<header class='py-3 mb-3 border-bottom' style='background-color: #31e621da'>
    <div class='container'>
      <div class='d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start'>
        ...
        <img src='/Proyecto/view/administrador/img/image.6.jfif' alt='mdo' width='32' height='32' class='rounded-circle'>
        </a>
        ...
        <div class='d flex'>
          ...
          <div class='dropdown-menu'>
            ...
            <a class='dropdown-item' href='/Proyecto/controller/cerrarSesion.php'>Cerrar sesion</a>
          </div>
        </div>
      </div>
    </div>
