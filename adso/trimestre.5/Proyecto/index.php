...
<body>
    ...
    require_once 'includeUsuario/header.php';
    ...
    <div class="barramenu">
        <nav class="menu-productos row">
            <a href="/Proyecto/carrito/catcombos.php" class="col-sm"> <img src="/Proyecto/img/combo.png" alt="icono Combos">Combos </a>
            <a href="/Proyecto/carrito/catpizza.php" class="col-sm"> <img src="/Proyecto/img/pizza.png" alt="icono Pizzas">Pizzas</a>
            <a href="/Proyecto/carrito/catpollo.php" class="col-sm"> <img src="/Proyecto/img/pollo.png" alt="icono Pollos">Pollos</a>
            <a href="/Proyecto/carrito/catburguer.php" class="col-sm"> <img src="/Proyecto/img/hamburguesa.png" alt="icono Pollos">Hamburguesas</a>
            <a href="/Proyecto/carrito/catespecialidades.php" class="col-sm"> <img src="/Proyecto/img/especialidades.png" alt="icono Especiales">Especialidades</a>
            <a href="/Proyecto/carrito/catbebidas.php" class="col-sm"> <img src="/Proyecto/img/bebida.png" alt="icono Bebidas">Bebidas</a>
        </nav>
            ...
            <div id="myCarousel" class="carousel slide col-md-auto" data-ride="carousel">
                ...
                <div class="carousel-inner width:50% height:50%;">
                    <div class="item active">
                        <img src="/Proyecto/img/Hamburguesas.jpg" alt="Los Angeles" style="width:100%;;">
                    ...
                    <div class="item">
                        <img src="/Proyecto/img/pollo.jpg" alt="Chicago" style="width:100%;">
                        <div class="carousel-caption">
                    ...
                    <div class="item">
                        <img src="/Proyecto/img/pizza.jpg" alt="New york" style="width:100%;">
                        <div class="carousel-caption">
