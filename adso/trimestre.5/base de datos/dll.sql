...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-09-2023 a las 01:42:07
...
(5, 'hamburguesa de carne', 11300, 2, 20, 18080, 12410, 6),
...
--
ALTER TABLE `det_promo`
  MODIFY `idPromo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `productos`
  MODIFY `idProducto` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
