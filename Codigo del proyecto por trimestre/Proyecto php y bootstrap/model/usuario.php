<?php
  ...
  class Usuario extends Conexion
  {
    ...
    public function registroUsuario($name, $email, $clave, $tel, $apellido, $genero, $fecha_naci , $tipo_doc, $doc, $fecha_reg, $direccion)
    {
      parent::conectar();
      ...
      $genero = parent::filtrar($genero);
      $fecha_naci = parent::filtrar($fecha_naci);
      $tipo_doc = parent::filtrar($tipo_doc);
      $doc = parent::filtrar($doc);
      $fecha_reg = parent::filtrar($fecha_reg);
      ...
      if($verificarCorreo > 0){
        ...
        parent::query('insert into usuarios(nombre, apellido, email, genero, fecha_naci, tipo_doc, doc, clave, cargo, tel, fecha_reg, direccion) values("'.$name.'","'.$apellido.'", "'.$email.'", "'.$genero.'", "'.$fecha_naci.'", "'.$tipo_doc.'", "'.$doc.'", MD5("'.$clave.'"), 2, "'.$tel.'", "'.$fecha_reg.'", "'.$direccion.'")');
