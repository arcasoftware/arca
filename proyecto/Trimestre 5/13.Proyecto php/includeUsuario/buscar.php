...
<body>
    ...
    <div class="center mb-6">
        <?php
        require_once '/xampp/apache/htdocs/Proyecto/view/conexion/conexion.php';
...
<?php
            ...
            echo "<img src='../img/Error.png' alt='Imagen de error' style = 'width: 300px; height: 300px;' class = 'center'>

        <h2>El producto que estas buscando no se encuentra Disponible</h2>";
        }
?>
